...
class RevenuesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create revenue" do
    assert_difference("Revenue.count") do
      post revenues_url, params: { revenue: { amount: @revenue.amount, category_id: @revenue.category_id, date: @revenue.date, description: @revenue.description, name: @revenue.name, user_id: @revenue.user_id } }
    end
  ...
  test "should update revenue" do
    patch revenue_url(@revenue), params: { revenue: { amount: @revenue.amount, category_id: @revenue.category_id, date: @revenue.date, description: @revenue.description, name: @revenue.name, user_id: @revenue.user_id } }
